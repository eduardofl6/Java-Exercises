...
public class Exercise3_20 {
	...
	Scanner input = new Scanner(System.in);
		...
		if(!(temp >= -58 && temp <= 41))
			System.out.print("Temperature input is out of range");
		if(!(windspeed >= 2 && windspeed <= 7))
			System.out.print("Wind speed input is out of range");
		
		if((temp >= -58 && temp <= 41) && (windspeed >= 2 && windspeed <= 7) )
			System.out.print("The wind chill index is " + ( (int)( wind_chill * 1000) / 100.0)+ "F");
